...
public class TransferMsg2ByteWithEncryptEncoder extends MessageToByteEncoder<TransferMsg> {
    private static final Logger LOGGER = LoggerFactory.getLogger(TransferMsg2ByteWithEncryptEncoder.class);
    private String password;

    public TransferMsg2ByteWithEncryptEncoder() {
